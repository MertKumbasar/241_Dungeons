...
public:
    ...
    Rogue(string name, int health, int attackPower, int defense, int critChance) :
        Player(name, health, attackPower, defense) {
    ...
    void attack(Enemy &enemy) {
        ...
        if (chance <= Crit_Strike_Chance) {
            ...
            cout << name << " lands a critical strike on " << enemy.getName() << "!" << endl;
